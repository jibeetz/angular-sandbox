module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      main: {expand: true, cwd: 'app/', src: options.filesToCopy, dest: 'dist/'}
    },
    'string-replace': {
      inline: {
        files: [{
  ...
  grunt.registerTask('serve', ['jshint', 'less', 'concat:css', 'concat:js', 'connect', 'watch']);
  grunt.registerTask('build', ['jshint', 'less', 'concat:css', 'concat:js', 'copy', 'uglify:prod', 'cssmin', 'string-replace']);
